...
MODEL_CATALOG: dict[str, dict] = {
    ...
    "gemini/gemini-2.0-pro":       {"provider": PROVIDER_GEMINI,    "tier": "primary",   "max_tokens": 1_000_000},
    "gemini/gemini-2.0-flash":     {"provider": PROVIDER_GEMINI,    "tier": "mini",      "max_tokens": 25_000},
    # ── Anthropic ───────────────────────────────────────────────────────
    "anthropic/claude-sonnet-4-20250514":   {"provider": PROVIDER_ANTHROPIC, "tier": "primary",   "max_tokens": 16_000},
    "anthropic/claude-haiku-3-20250519":    {"provider": PROVIDER_ANTHROPIC, "tier": "mini",      "max_tokens": 16_000},
    "anthropic/claude-3.5-sonnet-20241022": {"provider": PROVIDER_ANTHROPIC, "tier": "primary",   "max_tokens": 8_192},
    "anthropic/claude-3-haiku-20240307":    {"provider": PROVIDER_ANTHROPIC, "tier": "mini",      "max_tokens": 4_096},
    # ── OpenAI ──────────────────────────────────────────────────────────
    "openai/gpt-4o":               {"provider": PROVIDER_OPENAI,    "tier": "primary",   "max_tokens": 16_384},
    "openai/gpt-4o-mini":          {"provider": PROVIDER_OPENAI,    "tier": "mini",      "max_tokens": 16_384},
    "openai/gpt-4-turbo":          {"provider": PROVIDER_OPENAI,    "tier": "primary",   "max_tokens": 4_096},
    "openai/o3-mini":              {"provider": PROVIDER_OPENAI,    "tier": "mini",      "max_tokens": 16_384},
}

# Default model per provider (used when only a provider name is given)
DEFAULT_MODELS: dict[str, str] = {
    PROVIDER_GEMINI:    "gemini/gemini-2.5-pro",
    PROVIDER_ANTHROPIC: "anthropic/claude-sonnet-4-20250514",
